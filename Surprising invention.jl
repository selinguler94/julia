...
# ╔═╡ 4e7d28b0-7fb8-11ef-0a42-ef59139da2c2
begin
	import Base: Complex, real, imag, IOContext, stdout
...
# ╔═╡ 1a6f348e-4268-4486-90cb-1998ba33af08
...
# ╔═╡ 512dfba8-2a0a-4071-9c39-d0d0d4716ba7
gr()

# ╔═╡ 862519d7-5077-451d-ad92-88b024147a60
function test_eisenstein_primes(graphlimitsquared = 10_000, printlimit = 100)
    ...
    for (i, c) in enumerate(eprimes)
        if i <= printlimit
            print(lpad(round(Complex(c), digits = 4), 15), i % 5 == 0 ? "\n" : "")
        end
	end
	return eprimes
end

# ╔═╡ acab4df2-c24d-4396-a7db-0ea0eb4806ff
eprimes = test_eisenstein_primes()

# ╔═╡ 7ebf8d04-4918-4aa2-aefe-51854adaab8b
...
# ╔═╡ cf169b5f-894b-4e07-9098-280ba74c9173
plot_eprimes(eprimes)

# ╔═╡ 12a67113-68f4-47f5-a5c1-853f587e11eb
