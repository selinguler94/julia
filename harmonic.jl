...
begin
	Numberofcycles=500
	Numberofoscillators=100
	Totalenergy=200
	Group=1
	println("Number Of Cycles                                 : $Numberofcycles")
	println("Number Of Oscillators                            : $Numberofoscillators")
...
begin
	if Group < 1 || Group > Numberofoscillators
	    error("Error Group")
	end
	if Numberofcycles < 100
	    error("Please Increase the Number Of Cycles")
	end
	if Numberofoscillators <= 3
	    error("Error Number of Oscillators (Too Low or Too Large)....")
	end
	if Totalenergy < 3
	    error("Error Total Energy (Too Low or Too Large)....")
	end
end
...
begin
	## Make An Initial Distribution Of The Total
	## Energy Over The Levels
	while Utot != Totalenergy
	  i = rand(1:Numberofoscillators)
	  Oscillator[i] += 1
	  Utot += 1
	end
	println("\nInitial Energy                            : $Utot")
...
begin
    for I in 1:Numberofcycles
        for J in 1:100
            for K in 1:Numberofoscillators
                # Choose 2 Different Levels At Random
                Osca = rand(1:Numberofoscillators)
                Oscb = rand(1:Numberofoscillators)
...
:root {
    --main-width: 85%;
    --margin-left-custom: 7%;
    --margin-right-custom: 8%;
}
main {
    max-width: var(--main-width);
    margin-left: var(--margin-left-custom) !important;
    margin-right: var(--margin-right-custom) !important;
}
</style>
"""
...
manifest_format = "2.0"
project_hash = "c4e4c16ea4ad27abc20254ba0059cac865659c51"
