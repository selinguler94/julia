...
# ╔═╡ f8c27860-886a-11ef-2398-d378846cc018
using DifferentialEquations

# ╔═╡ add066e4-19d1-419a-bf20-20cd1e42b5c3
using Plots

# ╔═╡ 4fb2aa82-a2e4-45e7-ae7e-764ded2edf12
...
# ╔═╡ 2e05bfec-4a0f-462f-bfd1-be6a6abcb905
P = [1.0, 9.8]

# ╔═╡ be7f5aee-3a46-42e3-8266-aa6f21556ea1
begin
	angles = [5,90,175]
	u0_list = []
	for ang in angles
		u0 = [deg2rad(ang), 0] # why we define u0 as an matrix? First value: initial angle, and second value is initial angular velocity. but check again!!!!
		push!(u0_list, u0) # we just converted to radian
	end
end

# ╔═╡ b04b7178-d62c-4c59-b1ac-2ecb8dfcd365
tspan = (0, 20)

# ╔═╡ a4fc8c47-8857-4eec-85d8-235f444bb73c
solution = []

# ╔═╡ bf6bf2b6-1fbd-4a8f-bcc5-fc8bebeb1dc6
for el in u0_list
...
# ╔═╡ 949ef125-4a76-4e75-9638-0373ffd911d8
print(solution)

# ╔═╡ aaff180a-5e1e-4104-86b5-de5f8c6d9b9c
begin
