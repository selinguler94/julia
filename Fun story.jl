...
# ╔═╡ f1f8ed80-8887-11ef-1a57-49d028044fa8
begin
	using DifferentialEquations
	using Plots  # Ensure you have the Plots library
	...
	for u0 in u0_list
	    ...
	    sol = solve(prob)
	    push!(solution, sol(0:0.1:10)[1, :])  # Store θ over time
	end
	...
	# Loop to plot remaining solutions
	for (i, sol) in enumerate(solution[2:end])
	    plot!(sol; idxs=1, lw=4, lc=i==1 ? :blue : :red, label="θ₀=$(angles[i+1])°", legend=:outerright)
	end
