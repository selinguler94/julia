...
# ╔═╡ b4c8e4fd-23a9-4262-ad8c-9e2e97291464
using DifferentialEquations

# ╔═╡ 2e312a45-4de3-4e92-a723-cd475141fe82
using Plots

# ╔═╡ 92db8df0-847f-11ef-35d4-892112860448
...
# ╔═╡ 4f726742-e235-448b-ade4-2926e3e249d8
p = [1.0, 9.8]
# L g <- Parameters

# ╔═╡ c2d33432-a736-4feb-9695-42cf4ec1b8a3
begin
	angles = [5,90,175]
	u0_list = []
...
# ╔═╡ dd9f57e2-a992-4dfe-a5ff-2b057839f244
println(u0_list)

# ╔═╡ 109a78b6-20c7-4041-8199-355b5a058b23
tspan = (0, 20)

# ╔═╡ f096836d-b5f3-4964-bdbf-b7494efca056
solution = []

# ╔═╡ 7f673c81-cb2f-4377-b882-3f1537969b4f
for (k, el) in enumerate(u0_list)
		prob = ODEProblem(pendulum!, el, tspan, p)
		sol5d = solve(prob)
		push!(solution, sol5d(0:0.1:10)[1, :])
end

# ╔═╡ d1d2892b-055c-429d-a0ee-6c7cb6bc9caa
print(solution)

# ╔═╡ 2476ec88-89f5-42cc-b038-71beb13e888e


# ╔═╡ 8c657043-22a7-432b-8605-3b9b48c39820
begin
...
# ╔═╡ 404fb10d-209d-49c8-9ffd-f72b0750f325
solution[1].u[:1,1]

# ╔═╡ 3819f3d7-1fe4-4310-b849-88284c945a77
begin
	for i in range(1,length(solution))
		print(i)
		plot(solution[i]; idxs=1, lw=4, lc=:green, label="θ₀=°",
	legend=:outerright, title="Simple Gravity Pendulum")
	end
end

# ╔═╡ 0a8a954e-ad20-4fbe-aec5-74f8f136b9c2
L, g = p
